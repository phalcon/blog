...
flowchart BT
    ...
    classDef model      fill:#4bacc6,stroke:#3d8ba1,color:#ffffff
    classDef view       fill:#9bbb59,stroke:#7d9847,color:#ffffff
    classDef controller fill:#f79646,stroke:#c67735,color:#ffffff
    classDef server     fill:#bfbfbf,stroke:#9a9a9a,color:#333333
    classDef browser    fill:#a5a5a5,stroke:#858585,color:#ffffff
