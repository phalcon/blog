...
Our documentation has changed also to [nimbus-docs][nimbus_docs] (based on Astro). This move offered a much easier way to handle versions and redirects, which were sore points in our deployment process. A lot of the versioning and redirections are now parameter based, which helps us with new deployments.
...
[nimbus_docs]: https://nimbus-docs.com/
