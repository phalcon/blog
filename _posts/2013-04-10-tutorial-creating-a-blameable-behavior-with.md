...
Phalcon provides [behavior management](https://docs.phalcon.io/latest/en/db-models#behaviors), allowing us to add several behaviors to the same model that implements the same events. A behavior can be easily added to a model in the following way:
