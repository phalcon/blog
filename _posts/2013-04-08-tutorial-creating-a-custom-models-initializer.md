...
### Conclusion
This tutorial explains various strategies to extend Phalcon, the use of annotations, some additional information about the inner workings of the [ORM](https://docs.phalconphp.com/latest/en/models.html). We hope that this example serve as a guide to create more robust applications with Phalcon.
