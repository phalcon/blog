---
layout: post
title: Phalcon v4.1.0 released
image: /assets/files/2020-10-31-phalcon-4.1.0.png
date: 2020-10-31T16:15:37.403Z
tags:
  - phalcon
  - phalcon4
  - release
...
[Github Tag](https://github.com/phalcon/cphalcon/releases/tag/v4.1.0)

This release offers new features requested by the community as well as bug fixes reported by the community.

As per our blog post [The future of Phalcon](/post/the-future-of-phalcon), this will be the last version we release for Phalcon as a PHP extension.
...
The packages in [packagecloud.io](https://packagecloud.io/phalcon) are being updated (at the time of this post) and will be ready soon. You will need to use the `mainline` repository to install v4.1.0. You can also download the zip file, as well as DLLs for Windows, from our release page [here](https://github.com/phalcon/cphalcon/releases/tag/v4.1.0).
