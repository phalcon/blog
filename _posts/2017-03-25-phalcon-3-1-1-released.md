...
For more information read [our documentation](https://docs.phalconphp.com/latest/en/validation.html#callback-validator)
...
And you can type-hint your action parameters with class names. For more information read docs: [using in micro](https://docs.phalconphp.com/latest/en/micro.html#inject-model-instances), [using in dispatcher](https://docs.phalconphp.com/latest/en/dispatching.html#inject-model-instances)
...
```
  ...
  More information can be found in our documentation: [validating collections](https://docs.phalconphp.com/pl/latest/reference/odm.html#validating-data-integrity), [validation](https://docs.phalconphp.com/latest/en/validation.html)
