...
You can see all of the 2019 commits in [cphalcon](https://github.com/phalcon/cphalcon) visualized here: [https://youtu.be/VpQHjOUvlTs](https://youtu.be/VpQHjOUvlTs)
...
![](https://assets.phalcon.io/phalcon/images/emoji/heart.png) Phalcon TeamWe are very happy to announce the release of **Phalcon v4.0.0 Stable**!. 
