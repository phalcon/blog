...
- Fixed `Phalcon\Forms\Form::getMessages` to return back previous behavior: return array of messages with element name as key [#13294](https://github.com/phalcon/cphalcon/issues/13294)
